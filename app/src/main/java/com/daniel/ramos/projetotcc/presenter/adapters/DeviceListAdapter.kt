...
import com.daniel.ramos.projetotcc.model.unmannaged.DeviceInfoModel

class DeviceListAdapter(private val context: Context, private val deviceList: List<BluetoothDevice>) : RecyclerView.Adapter<DeviceListAdapter.ViewHolder>() {
